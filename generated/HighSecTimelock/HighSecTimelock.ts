...
export class HighSecTimelock extends ethereum.SmartContract {
  static bind(address: Address): HighSecTimelock {
    return new HighSecTimelock("HighSecTimelock", address);
  }
